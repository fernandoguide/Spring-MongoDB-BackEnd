package br.com.fernando.crud.config;
...
public class SwaggerConfig {
	...
	private final ResponseMessage m201 = simpleMessage(201, "Recurco Criado");
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).useDefaultResponseMessages(false)
				...
				.apis(RequestHandlerSelectors.basePackage("br.com.fernando.crud.controller")).paths(PathSelectors.any())
